        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('admin.itinerary.kota.index') }}"
                    class="btn btn-outline-primary px-4 shadow-sm rounded-pill">
                    <i class="bi bi-geo-alt-fill me-1"></i> Tambah Kota
                </a>

                <!-- Button Tambah Itinerary -->
            ...
            <div class="card itinerary-card mb-3 p-3">
                ...
                <div class="d-flex justify-content-between flex-wrap">
                    ...
                    <div class="d-flex align-items-start gap-2">
                        ...
                        <a href="{{ route('admin.itinerary.show', $it) }}" class="btn btn-success btn-sm action-btn"
                            data-bs-toggle="tooltip" title="Lihat Detail">
                            <i class="bi bi-journal-text"></i>
                        </a>

                        <a href="{{ route('admin.itinerary.edit', $it) }}"
                            class="btn btn-outline-secondary btn-sm action-btn" data-bs-toggle="tooltip"
                        ...
                        <form action="{{ route('admin.itinerary.destroy', $it) }}" method="POST"
                            ...
                            @csrf @method('DELETE')
                            <button class="btn btn-outline-danger btn-sm action-btn" data-bs-toggle="tooltip"
                                title="Hapus">
