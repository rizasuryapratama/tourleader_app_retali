                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="kloter_id" id="kloter_id" class="form-select" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="sesi_absen_id" id="sesi_absen_id" class="form-select" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select name="sesi_absen_item_id" id="sesi_absen_item_id" class="form-select" disabled required>
